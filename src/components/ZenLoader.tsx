...
const ZenLoader = ({ isVisible }: ZenLoaderProps) => (
  <AnimatePresence>
    {isVisible && (
      <motion.div
        className="fixed inset-0 flex items-center justify-center bg-[#070546] z-[9999]"
      ...
      >
        ...
        <div className="pl">
          ...
          <div className="pl__dot" />
          <div className="pl__dot" />
          <div className="pl__text">Aroha</div>
        </div>
      </motion.div>
    )}
  </AnimatePresence>
